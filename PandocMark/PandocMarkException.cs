...
{
    /// <summary>
    /// An exception that is caught during PandocMark parsing or formatting.
    /// </summary>
#if NET20 || NET35_CLIENT || NET40_CLIENT || NET45
    [Serializable]
#endif
    public class PandocMarkException : Exception
    {
        /// <summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="PandocMarkException" /> class.</summary>
        public PandocMarkException() { }

        /// <summary>Initializes a new instance of the <see cref="PandocMarkException" /> class with a specified error message.</summary>
        /// <param name="message">The message that describes the error.</param>
        public PandocMarkException(string message) : base(message) { }

        /// <summary>Initializes a new instance of the <see cref="PandocMarkException" /> class with a specified error message and a reference to the inner exception that is the cause of this exception.</summary>
        /// <param name="message">The error message that explains the reason for the exception.</param>
        /// <param name="innerException">The exception that is the cause of the current exception, or <see langword="null"/> if no inner exception is specified.</param>
        public PandocMarkException(string message, Exception innerException) : base(message, innerException) { }

        /// <summary>Initializes a new instance of the <see cref="PandocMarkException" /> class with a specified error message, a reference to the element that caused it and a reference to the inner exception that is the cause of this exception.</summary>
        /// <param name="message">The error message that explains the reason for the exception.</param>
        /// <param name="inline">The inline element that is related to the exception cause.</param>
        /// <param name="innerException">The exception that is the cause of the current exception, or <see langword="null"/> if no inner exception is specified.</param>
        public PandocMarkException(string message, Inline inline, Exception innerException = null)
        ...
        /// <param name="innerException">The exception that is the cause of the current exception, or <see langword="null"/> if no inner exception is specified.</param>
        public PandocMarkException(string message, Block block, Exception innerException = null)
            : base(message, innerException) 
        {
...
#if NET20 || NET35_CLIENT || NET40_CLIENT || NET45
        /// <summary>Initializes a new instance of the <see cref="PandocMarkException" /> class from the specified instances of the <see cref="System.Runtime.Serialization.SerializationInfo" /> and <see cref="System.Runtime.Serialization.StreamingContext" /> classes.</summary>
