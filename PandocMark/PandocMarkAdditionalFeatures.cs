...
{
    /// <summary>
    /// Lists additional features that can be enabled in <see cref="PandocMarkSettings"/>.
    /// These features are not part of the standard and should not be used if interoperability with other
    /// PandocMark implementations is required.
    /// </summary>
    [Flags]
    public enum PandocMarkAdditionalFeatures
    {
        /// <summary>
