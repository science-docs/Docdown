...
namespace PandocMark.Syntax
{
    ...
    public enum InlineTag : byte
    {
        ...
        /// the display of the resulting HTML code. The <see cref="PandocMarkSettings.RenderSoftLineBreaksAsLineBreaks"/>
        ...
        /// Only present if the <see cref="PandocMarkAdditionalFeatures.StrikethroughTilde"/> is enabled.
        /// </summary>
        Strikethrough,
        ...
        /// Only present if the <see cref="PandocMarkAdditionalFeatures.PlaceholderBracket"/> is enabled.
        /// </summary>
        Placeholder,

        /// <summary>
        /// Represents a TeX tag
        /// </summary>
        Tex
    }
}
