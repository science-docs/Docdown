namespace PandocMark.Parser
{
    ...
    internal static partial class Scanner
    {
        ...
        /// </summary>
        public static int ScanAutolinkUri(string s, int pos, int sourceLength)
        {
        ...
        /// </summary>
        public static int ScanAutolinkEmail(string s, int pos, int sourceLength)
        {
            /*!re2c
              [a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+
                [@]
        ...
        /// </summary>
        public static int ScanLinkUrl(string s, int pos, int sourceLength)
        {
            /*!re2c
        ...
        /// </summary>
        public static int ScanLinkTitle(string s, int pos, int sourceLength)
        {
            /*!re2c
        ...
        /// </summary>
        public static int ScanSpacechars(string s, int pos, int sourceLength)
        {
            /*!re2c
              [ \t\n]* { return (p - start); }
              . { return 0; }
        ...
        /// </summary>
        public static int ScanAtxHeadingStart(string s, int pos, int sourceLength, out int headingLevel)
        {
            /*!re2c
              [#]{1,6} ([ ]+|[\n])  { return (p - start); }
              .? { return 0; }
        ...
        /// </summary>
        public static int ScanSetextHeadingStart(string s, int pos, int sourceLength)
        {
            /*!re2c
              [=]+ [ ]* [\n] { return 1; }
              [-]+ [ ]* [\n] { return 2; }
        ...
        /// </summary>
        public static int ScanThematicBreak(string s, int pos, int sourceLength)
        {
            // @"^([\*][ ]*){3,}[\s]*$",
            // @"^([_][ ]*){3,}[\s]*$",
            // @"^([-][ ]*){3,}[\s]*$",
        ...
        /// 
        /// </summary>
        public static int ScanMetaDataOpen(string s, int pos, int sourceLength)
        {
            // @"^([-][ ]*){3,}[\s]*$",
        ...
        /// </summary>
        public static int ScanOpenCodeFence(string s, int pos, int sourceLength)
        {
            /*!re2c
              [`]{3,} / [^`\n\x00]*[\n] { return (p - start); }
              [~]{3,} / [^~\n\x00]*[\n] { return (p - start); }
        ...
        /// </summary>
        public static int ScanCloseCodeFence(string s, int pos, int len, int sourceLength)
        {
            /*!re2c
              ([`]{3,} | [~]{3,}) / spacechar* [\n]
                                          { if (p - start > len) {
        ...
        /// Scan a closing code fence with length at least len.
        /// </summary>
        public static int ScanCloseMetaData(string s, int pos, int len, int sourceLength)
        {
            /*!re2c
              ([`]{3,} | [~]{3,}) / spacechar* [\n]
                                          { if (p - start > len) {
