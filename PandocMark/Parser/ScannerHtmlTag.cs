...
namespace PandocMark.Parser
{
    internal static partial class Scanner
    {
        ...
        public static Syntax.HtmlBlockType ScanHtmlBlockStart(string s, int pos, int sourceLength)
        {
        ...
        public static Syntax.HtmlBlockType ScanHtmlBlockStart7(string s, int pos, int sourceLength)
        {
            if (pos + 2 >= sourceLength)
                return Syntax.HtmlBlockType.None;
            ...
            int i = pos;
            if (s[++i] == '/')
                i = ScanHtmlTagCloseTag(s, i, sourceLength);
            else
                i = ScanHtmlTagOpenTag(s, i, sourceLength);
        ...
        public static bool ScanHtmlBlockEnd(Syntax.HtmlBlockType type, string s, int pos, int sourceLength)
        {
            switch (type)
            {
                case Syntax.HtmlBlockType.InterruptingBlockWithEmptyLines:
                    return ScanHtmlBlockEnd1(s, pos, sourceLength);
                case Syntax.HtmlBlockType.Comment:
                    return ScanHtmlBlockEnd2(s, pos, sourceLength);
                case Syntax.HtmlBlockType.ProcessingInstruction:
                    return ScanHtmlBlockEnd3(s, pos, sourceLength);
                case Syntax.HtmlBlockType.DocumentType:
                    return ScanHtmlBlockEnd4(s, pos, sourceLength);
                case Syntax.HtmlBlockType.CData:
                    return ScanHtmlBlockEnd5(s, pos, sourceLength);
                default:
                    return false;
            }
        }

        private static bool ScanHtmlBlockEnd1(string s, int pos, int sourceLength)
        {
...
#endif
        private static bool ScanHtmlBlockEnd2(string s, int pos, int sourceLength)
        {
        ...
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
#endif
        private static bool ScanHtmlBlockEnd3(string s, int pos, int sourceLength)
        {
            //  .* '?>' { return (bufsize_t)(p - start); }
        ...
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
#endif
        private static bool ScanHtmlBlockEnd4(string s, int pos, int sourceLength)
        {
            //  .* '>' { return (bufsize_t)(p - start); }
        ...
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
#endif
        private static bool ScanHtmlBlockEnd5(string s, int pos, int sourceLength)
        {
            //  .* ']]>' { return (bufsize_t)(p - start); }
            var i = s.IndexOf("]]>", pos, sourceLength - pos, StringComparison.Ordinal);
            return i > -1;
        ...
        private static int ScanHtmlTagCloseTag(string s, int pos, int sourceLength)
        {
        ...
        private static int ScanHtmlTagProcessingInstruction(string s, int pos, int sourceLength)
        {
        ...
        private static int ScanHtmlTagHtmlComment(string s, int pos, int sourceLength)
        {
        ...
        private static int ScanHtmlTagCData(string s, int pos, int sourceLength)
        {
        ...
        private static int ScanHtmlTagDeclaration(string s, int pos, int sourceLength)
        {
        ...
        private static int ScanHtmlTagOpenTag(string s, int pos, int sourceLength)
        {
        ...
        /// </summary>
        public static int ScanHtmlTag(string s, int pos, int sourceLength)
        {
            if (pos + 2 >= sourceLength)
                return 0;
            ...
            if (firstChar == '/')
                return ScanHtmlTagCloseTag(s, pos, sourceLength);

            if (firstChar == '?')
                return ScanHtmlTagProcessingInstruction(s, pos, sourceLength);

            if (firstChar == '!')
            {
                var nextChar = s[pos + 1];
                if (nextChar == '-')
                    return ScanHtmlTagHtmlComment(s, pos, sourceLength);

                if (nextChar == '[')
                    return ScanHtmlTagCData(s, pos, sourceLength);

                return ScanHtmlTagDeclaration(s, pos, sourceLength);
            }

            return ScanHtmlTagOpenTag(s, pos, sourceLength);
        }
    }
}
