...
namespace PandocMark.Formatters
{
    /// <summary>
    /// An extendable implementation for writing PandocMark data as HTML.
    /// </summary>
    public class HtmlFormatter
    {
        ...
        /// </summary>
        protected Stack<bool> RenderTightParagraphs { get; } = new Stack<bool>(new[] { false });
        ...
        /// The most recent value is used to determine the current state.
        /// </summary>
        protected Stack<bool> RenderPlainTextInlines { get; } = new Stack<bool>(new[] { false });
        ...
        /// </summary>
        protected PandocMarkSettings Settings { get; }

        /// <summary>
        /// Writes the given PandocMark document to the output stream as HTML.
        /// </summary>
            ...
            switch (inline.Tag)
            {
                ...
                case InlineTag.Placeholder:
                    ...
                    if (isOpening)
                    {
                        ...
                        {
                            throw new PandocMarkException("An error occurred while resolving a placeholder.", ex);
                        }
        ...
        /// This method should only be called if <see cref="PandocMarkSettings.TrackSourcePosition"/> is set to <see langword="true"/>.
