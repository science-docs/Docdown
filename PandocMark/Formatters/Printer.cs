            ...
            while (inline != null)
            {
                ...
                switch (inline.Tag)
                {
                    case InlineTag.String:
                        ...
                        writer.Write(' ');
                        writer.Write(FormatString(inline.LiteralContent, buffer));
                        break;
                    ...
                    case InlineTag.Code:
                        writer.Write("code {0}", FormatString(inline.LiteralContent, buffer));
                        PrintPosition(trackPositions, writer, inline);
                        writer.Write(' ');
                        writer.Write(FormatString(inline.LiteralContent, buffer));
                        break;
                    ...
                    case InlineTag.RawHtml:
                        writer.Write("html_inline {0}", FormatString(inline.LiteralContent, buffer));
                        writer.Write(' ');
                        writer.Write(FormatString(inline.LiteralContent, buffer));
                        break;
                    ...
                    case InlineTag.Link:
                        ...
                        writer.Write(" url={0} title={1}",
                               FormatString(inline.TargetUrl, buffer),
                               FormatString(inline.LiteralContent, buffer));
                        break;
